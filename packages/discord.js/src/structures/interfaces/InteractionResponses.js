...
class InteractionResponses {
  ...
  async deferReply(options = {}) {
    ...
    const response = await this.actuallyRespond({
      body: {
    ...
    return options.withResponse && response
  ...
  async launchActivity({ withResponse } = {}) {
    ...
    return withResponse && response ? new InteractionCallbackResponse(this.client, response) : undefined;
  }
  ...
  async showModal(modal, options = {}) {
    ...
    return options.withResponse && response ? new InteractionCallbackResponse(this.client, response) : undefined;
  }
