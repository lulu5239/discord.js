...
class BaseInteraction extends Base {
  constructor(client, data) {
    ...
    this.respondFunction = data.respondFunction
  }
  ...
  async actuallyRespond (things) {
    if(this.respondFunction){
      this.respondFunction(global.respondFunctionOverride ? global.respondFunctionOverride(this, things) : things)
      delete this.respondFunction
    }else{
      return await this.client.rest.post(Routes.interactionCallback(this.id, this.token), {
        auth: false,
        ...things,
      });
    }
